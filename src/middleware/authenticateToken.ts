...
// Validate JWT payload structure with zero trust
function validatePayload(payload: JwtPayload): tokenPayload | null {
    if (
...
export const authenticateToken = (
    ...
    try {
        ...
        if (!token) {
            return handleError(res, 401, "Authentication token missing.");
        }
